...
class Usuario:
    ...
    def get_all(cls):
        ...
        sql = """
        SELECT id, email, password, created_at, updated_at FROM usuarios;
        """
    ...
    def crear(self):
        sql = f"INSERT INTO usuarios (email,password ,created_at,updated_at) VALUES (%(email)s,%(password)s,NOW(),NOW());"
        data = {
            'email': self.email,
    ...
    def get(cls, id):
        sql = """
        SELECT id, email, password, created_at, updated_at FROM usuarios where id = %(id)s;
        """
        data = {
            'id': id
        }
    ...
    def get_by_email(cls, email):
        sql = """
        SELECT id, email, password, created_at, updated_at FROM usuarios where email = %(email)s;
        """
        data = {
            'email': email
        }
